use crate::{
    block::BlockSelection, hypersync_net_types_capnp, log::LogSelection, trace::TraceSelection,
    ...
    fn populate_capnp_query(
        ...
        // Set field selection
        {
            ...
            let mut trace_list = field_selection
                .reborrow()
                .init_trace(trace_fields.len() as u32);
