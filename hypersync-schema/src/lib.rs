...
pub fn transaction() -> SchemaRef {
    Schema::from(vec![
        ...
        Field::new("tx_y_parity", quantity_dt(), true),
        Field::new("tx_access_list", DataType::BinaryView, true),
        Field::new("tx_l1_fee", quantity_dt(), true),
        Field::new("tx_l1_gas_price", quantity_dt(), true),
        Field::new("tx_l1_gas_used", quantity_dt(), true),
        Field::new("tx_l1_fee_scalar", quantity_dt(), true),
        Field::new("tx_gas_used_for_l1", quantity_dt(), true),
